...
namespace BANKING_APPLICATION.Implementation.Account_Implementation
{
    ...
    {
        public void PromptToViewAccount(Customer UserLoggedIn)
        {
            string choice;
            bool isValid;
            do
        ...
        public void ShowAllAccount(Customer UserLoggedIn)
        {
            ...
            {
                allprints += $"|   {acc.Id,-14}  |   {acc.Name,-14}  |   {acc.AccountNumber,-15}  |  {acc.AccountType,-15}  |  {acc.Balance,-16}  |\n";
            }
            Console.WriteLine("|-------------------|-------------------|--------------------|-------------------|--------------------|");
